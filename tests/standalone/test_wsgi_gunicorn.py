...
def test_load_config(mock_set_config):
    ...
    Asserter.assert_equals(calls[24], call("user", 1000))
    Asserter.assert_equals(calls[25], call("group", 1000))
    ...
    Asserter.assert_equals(calls[28], call("threads", 25))
    Asserter.assert_equals(calls[29], call("workers", 12))
