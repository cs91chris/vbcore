...
from vbcore.dictutils import FlatDict, FlatterDict
...
class FlatDictTests(unittest.TestCase):
    ...
    def test_iter_keys(self):
        self.assertListEqual(sorted(self.KEYS), sorted(k for k in iter(self.value)))
    ...
    def test_iter_items(self):
        items = list(self.value.iteritems())
    ...
    def test_set_delimiter(self):
        ...
        self.assertListEqual(
            sorted(k.replace(":", "-") for k in self.KEYS), sorted(self.value.keys())
        )
        self.assertListEqual(
